...
export default function Page() {
    return (
        <>
            {/* Header */}
            <header className="flex items-center justify-center bg-blue-600 text-white p-4">
                <h1 className="text-xl font-bold">Selamat Datang Di UIA</h1>
            </header>
                    ...
                    <form className="space-y-3">
                        <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
                            <h1 className={`${lusitana.className} mb-3 text-2xl`}>
                                Silahkan Login ke Account Anda.
                            </h1>
                            {/* Email Input */}
                        ...
                        {/* Form Errors */}
                        <div className="flex h-8 items-end space-x-1 text-sm text-red-500">
